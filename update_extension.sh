...
echo "Firefox Add-ons:  https://addons.mozilla.org/en-US/developers/"
echo ""
echo "Chrome Extension ID: mdjhjmefckhheleoegfcobijefkpfppo"
echo "Firefox Extension ID: {aa60beb9-2577-4eea-ae50-14a97ad9653d}"
echo "-------------------------------------------------"
